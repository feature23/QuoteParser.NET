...
namespace QuoteParser.Tests
{
    public class SLTests : EmailTestBase
    {
        ...
        // NOTE: some of the start/end line numbers are different than the upstream Kotlin project,
        // due to the MimeKit library reading in multiple lines differently. Changes are noted in comments.
        // It would be great to achieve true parity here, but I'm not sure how important to the end user
        // the indexes are anyways.
        [Theory]
        ...
        [InlineData(108, 10, 11, "On 12/05/2014 13:00, Professor X wrote:")] // NOTE: was 13, 14
        ...
        [InlineData(245, 28, 29, "On 02/06/2014 11:34, Wonder Woman wrote:")] // NOTE: was 33, 34
        [InlineData(259, 28, 30, "> Capitan America <mailto:America.Capitan@avengers.com>", "> 10 Jun 2014 17:49")] // NOTE: was 35, 37
        ...
        [InlineData(1066, 12, 13, "On 7/11/14, 9:30 AM, X Y wrote:")] // NOTE: was 19, 20
        ...
        [InlineData(4169, 28, 28)] // NOTE: was 40, 40
